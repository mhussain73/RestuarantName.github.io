const images = document.querySelectorAll('#main .posts.active article:nth-of-type(9) .carousel .img-container img');
const overlay = document.querySelector('#main .overlay:nth-of-type(9)');
const expandedImg = document.getElementById('expanded-img9');
let current = 0;
...
document.querySelector('#main .posts.active article:nth-of-type(9) .carousel').addEventListener('touchstart', (e) => {
  	startX = e.touches[0].clientX;
});
				
// Detect when user lifts their finger
document.querySelector('#main .posts.active article:nth-of-type(9) .carousel').addEventListener('touchend', (e) => {
