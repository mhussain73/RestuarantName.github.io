const images = document.querySelectorAll('#main .posts.active article:nth-of-type(2) .carousel .img-container img');
...
document.querySelector('#main .posts.active article:nth-of-type(2) .carousel').addEventListener('touchstart', (e) => {
  	startX = e.touches[0].clientX;
});
				
// Detect when user lifts their finger
document.querySelector('#main .posts.active article:nth-of-type(2) .carousel').addEventListener('touchend', (e) => {
