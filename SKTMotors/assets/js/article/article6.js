const images = document.querySelectorAll('#main .posts.active article:nth-of-type(6) .carousel .img-container img');
...
document.querySelector('#main .posts.active article:nth-of-type(6) .carousel').addEventListener('touchstart', (e) => {
  	startX = e.touches[0].clientX;
});
				
// Detect when user lifts their finger
document.querySelector('#main .posts.active article:nth-of-type(6) .carousel').addEventListener('touchend', (e) => {
