const images = document.querySelectorAll('#main .posts.active article:nth-of-type(10) .carousel .img-container img');
const overlay = document.querySelector('#main .overlay:nth-of-type(10)');
const expandedImg = document.getElementById('expanded-img10');
let current = 0;
...
document.querySelector('#main .posts.active article:nth-of-type(10) .carousel').addEventListener('touchstart', (e) => {
  	startX = e.touches[0].clientX;
});
				
// Detect when user lifts their finger
document.querySelector('#main .posts.active article:nth-of-type(10) .carousel').addEventListener('touchend', (e) => {
