const images = document.querySelectorAll('#main .posts.active article:nth-of-type(4) .carousel .img-container img');
const overlay = document.querySelector('#main .overlay:nth-of-type(4)');
const expandedImg = document.getElementById('expanded-img4');
let current = 0;
...
document.querySelector('#main .posts.active article:nth-of-type(4) .carousel').addEventListener('touchstart', (e) => {
  	startX = e.touches[0].clientX;
});
				
// Detect when user lifts their finger
document.querySelector('#main .posts.active article:nth-of-type(4) .carousel').addEventListener('touchend', (e) => {
