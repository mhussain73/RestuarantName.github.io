const images = document.querySelectorAll('#main .posts.active article:nth-of-type(7) .carousel .img-container img');
const overlay = document.querySelector('#main .overlay:nth-of-type(7)');
const expandedImg = document.getElementById('expanded-img7');
let current = 0;
...
document.querySelector('#main .posts.active article:nth-of-type(7) .carousel').addEventListener('touchstart', (e) => {
  	startX = e.touches[0].clientX;
});
				
// Detect when user lifts their finger
document.querySelector('#main .posts.active article:nth-of-type(7) .carousel').addEventListener('touchend', (e) => {
