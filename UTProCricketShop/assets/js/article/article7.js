const images = document.querySelectorAll('#main .posts article:nth-of-type(7) .carousel .img-container img');
...
document.querySelector('#main .posts article:nth-of-type(7) .carousel').addEventListener('touchstart', (e) => {
  	startX = e.touches[0].clientX;
});
				
// Detect when user lifts their finger
document.querySelector('#main .posts article:nth-of-type(7) .carousel').addEventListener('touchend', (e) => {
