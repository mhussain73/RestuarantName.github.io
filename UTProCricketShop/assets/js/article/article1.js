const images = document.querySelectorAll('#main .posts .carousel article:nth-of-type(1) .img-container img');
...
document.querySelector('#main .posts .carousel article:nth-of-type(1)').addEventListener('touchstart', (e) => {
  	startX = e.touches[0].clientX;
});
				
// Detect when user lifts their finger
document.querySelector('#main .posts .carousel article:nth-of-type(1)').addEventListener('touchend', (e) => {
