const images = document.querySelectorAll('#main .posts article:nth-child(1) .carousel .img-container img');
...
document.querySelector('#main .posts article:nth-child(1) .carousel').addEventListener('touchstart', (e) => {
  	startX = e.touches[0].clientX;
});
				
// Detect when user lifts their finger
document.querySelector('#main .posts article:nth-child(1) .carousel').addEventListener('touchend', (e) => {
